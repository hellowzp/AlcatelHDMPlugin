...
public class DownloadResponseDTOJsr extends JsObj implements ResponseDTOJsr, java.io.Serializable {
    private static final long serialVersionUID = 1L;

    private static final JsObjData S = 
        new JsObjData("hdm.functions.types.response.DownloadResponseDTO", DownloadResponseDTOJsr.class, "DownloadResponseDTO", true);
    ...
    public DownloadResponseDTOJsr(){
        super(S.getJsCmpMeta(), true);
    }

    protected DownloadResponseDTOJsr(JsCmpMeta cmpMeta, boolean isInstance, Object... args) {
    ...
    public static JsTypeRef<DownloadResponseDTOJsr> prototype = new JsTypeRef<DownloadResponseDTOJsr>(S);
}